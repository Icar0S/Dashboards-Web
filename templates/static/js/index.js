...
function renderiza_total_despesa(url) {
  fetch(url, {
    method: 'get',
  }).then(function (result) {
    return result.json()
  }).then(function (data) {
    document.getElementById('despesa_total').innerHTML = data.despesas
  })
...
function renderiza_despesas_mensal() {
  ...
  const myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Despesas',
        data: [1200, 1900, 300, 500, 200, 300, 1200, 190, 300, 500, 200, 300],
